...
**Level:** Intermediate  
**Goal:** Build a scored multiple-choice quiz with feedback.  
**Coding ideas:** Objects, arrays, conditions, DOM updates
...
2. Open the folder named `03-knowledge-quiz`.
...
1. Create a new public GitHub repository named `03-knowledge-quiz`.
...
`https://YOUR-USERNAME.github.io/03-knowledge-quiz/`
